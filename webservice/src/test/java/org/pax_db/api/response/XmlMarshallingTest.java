...
public class XmlMarshallingTest {
    ...
    public static void setup() throws JAXBException {
        ...
        hits.add(new SearchResultId("4235", "CDC42", "CDC42", "CDC42 annotation", ""));
        hits.add(new SearchResultId("7777", "CDC3", "CDC3", "CDC3 annotation", ""));
        results.add(new Hits("cdc", 4932L, hits, 2, 1, 10));

        hits = new ArrayList<SearchResultId>();
        hits.add(new SearchResultId("111", "ALD2", "ALD2", "ALD2 annotation", ""));
        hits.add(new SearchResultId("222", "POP7", "POP7", "POP7 annotation", ""));
        hits.add(new SearchResultId("333", "RPM2", "RPM2", "RPM2 annotation", ""));
